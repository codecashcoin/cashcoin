...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cashcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"learncointools.com", "159.203.117.240"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cashcoin is probably already running."), addrBind.ToString().c_str());
        else
